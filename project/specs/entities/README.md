...
2. Update `docs/project/specs/entity-key-table-master.md` (master table)
...
5. Update master `entity-key-table-master.md` if new GSI added
...
- **Master Entity-Key Table**: `../entity-key-table-master.md` - All entities at a glance
...
- Update `entity-key-table-master.md` whenever you add/modify an entity
...
- Check `entity-key-table-master.md` to see Merchant entity exists
...
- Add Favorites table to `entity-key-table-master.md`
